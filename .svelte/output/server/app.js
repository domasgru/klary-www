...
<main class="${"svelte-ocp1vb"}"><h1 class="${"svelte-ocp1vb"}">Hello wtfff!</h1>

	<p class="${"svelte-ocp1vb"}">Viasdasdsit <a href="${"https://svelte.dev"}">svelte.dev</a> to learn how to build Svelte apps.</p>
	<button>Insertee email</button>
</main>`;
});
